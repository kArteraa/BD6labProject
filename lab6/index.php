...
<body>
    ...
    <section class="main">
        ...
        <h3 class="main__info__childGarden" style="margin-top:20px;">Детский садик с номером <?php echo $_SESSION['id'] ?> находится по адрессу <?php echo $childGardenAdress['adress']; ?> </h3>
        <div class="container">
            <div class="main__inner">
                <div class="main__info">
                    ...
                    <div class="main__info__personal">
                        ...
                        <a href="query/add.php" style="color:#fff;text-decoration:none">Добавить</a>
                    ...
                    <div class="main__info__deliveries">
                        ...
                        <a href="query/add2.php" style="color:#fff;text-decoration:none">Добавить</a>
